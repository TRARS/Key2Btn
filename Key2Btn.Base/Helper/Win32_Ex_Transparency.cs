...
#pragma warning restore CS0618 // 类型或成员已过时
    ...
    public static partial class Win32_Ex_Transparency
    {
        public static void SetTransparency(Window window_obj)
        {
            ...
            {
                if (msg == (int)Win32_Ex_Transparency.WM.STYLECHANGING && (long)wParam == (long)Win32_Ex_Transparency.GetWindowLongFields.GWL_EXSTYLE)
                {
                    var styleStruct = (STYLESTRUCT)Marshal.PtrToStructure(lParam, typeof(STYLESTRUCT));
                    styleStruct.styleNew |= (int)Win32_Ex_Transparency.ExtendedWindowStyles.WS_EX_LAYERED;
            ...
            var _hwnd = new WindowInteropHelper(window_obj).Handle;
            Win32_Ex_Transparency.User32.SetWindowLongPtr(
                _hwnd,
                Win32_Ex_Transparency.GetWindowLongFields.GWL_EXSTYLE,
                (IntPtr)(int)((long)Win32_Ex_Transparency.User32.GetWindowLongPtr(_hwnd, Win32_Ex_Transparency.GetWindowLongFields.GWL_EXSTYLE) | (long)Win32_Ex_Transparency.ExtendedWindowStyles.WS_EX_TRANSPARENT)
                );
        }
    }
}
