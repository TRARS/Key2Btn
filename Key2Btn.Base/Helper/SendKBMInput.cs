...
{
    //引用dll部分
    public partial class SendKBMInput
    {
        #region 引用/声明
    ...
    public partial class SendKBMInput
    {
        ...
        private abstract class KeyState<T>
        {
            ...
            public static void Print(string str) { Debug.WriteLine($"(SendKBMInput) {str}"); }
        }
    ...
    public partial class SendKBMInput
    {
        ...
        private class KeyboardProxy : KBMProxy<KeyboardKeys>
        {
            ...
            public void SetKeyDown(KeyboardKeys[] keys)
            {
                foreach (var key in keys)
                {
                    SendKeyDown.Invoke(key);
                }
            }
            public void SetKeyUp(KeyboardKeys[] keys)
            {
                foreach (var key in keys)
                {
                    SendKeyUp.Invoke(key);
                }
            }
        }
    }
    ...
    public partial class SendKBMInput
    {
        ...
        /// <summary>
        /// <para>键盘某键按下&amp;弹起</para>
        /// <para>参数 key：按哪个键（比如填'<see cref="System.Windows.Forms.Keys.Enter"/>'）</para>
        /// </summary>
    ...
    public partial class SendKBMInput
    {
        ...
        /// <summary>
        /// <para>键盘某键按下或弹起一次</para>
        /// <para>参数 flag：true按下 false弹起</para>
        /// <para>参数 keys：一次性按多个键，Key数组（比如填'<see cref="System.Windows.Forms.Keys.Enter"/>'）</para>
        /// </summary>
        public static void KeyDownOnce(bool flag, params KeyboardKeys[] keys)
        {
            if (flag)
            {
                KeyboardProxy.Instance.SetKeyDown(keys);
            }
            else
            {
                KeyboardProxy.Instance.SetKeyUp(keys);
            }
        }
    }
}
